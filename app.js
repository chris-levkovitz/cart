...
const btns = document.querySelectorAll('.bag__btn');
// console.log(btns);
...
class UI {
    ...
    showCart(){
        cartOverlay.classList.add('cartPage');
    ...
    populateCart(cart){
        cart.forEach(item => this.addCartItem(item, this.showCart));
    }
    hideCart(){
        cartOverlay.classList.remove('cartPage');
